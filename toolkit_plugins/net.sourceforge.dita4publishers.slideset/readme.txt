Unzip this so that the net.sourceforge.dita4publishers.slideset subdirectory 
...
java -jar lib\dost.jar /i:doc\DITA-readme.ditamap /transtype:slideset

java -jar lib\dost.jar /i:doc\userguide\DITA-userguide.ditamap /transtype:slideset
