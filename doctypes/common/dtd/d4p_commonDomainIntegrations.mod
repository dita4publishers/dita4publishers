...
<!--                    These entries should be used by            -->
<!--                    all DITA For Publishers topic shells       -->
<!-- ============================================================= -->
...
<!ENTITY % d4p_enumerationTopic-d-def     PUBLIC 
"urn:pubid:dita4publishers.sourceforge.net:modules:dita:modules:d4p_enumerationTopicDomain" 
"d4p_enumerationTopicDomain.mod"
>
