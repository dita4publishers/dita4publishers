...
<!ATTLIST epigraph               %global-atts;  class CDATA "- topic/bodydiv pubcontent/epigraph ">
<!ATTLIST epigraph-attribution   %global-atts;  class CDATA "- topic/p       pubcontent/epigraph-attribution ">
