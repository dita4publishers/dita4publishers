...
git clone git@github.com:dita-community/org.dita-community.common.mapdriven.git
git clone git@github.com:dita-community/org.dita-community.preprocess-extensions.git
