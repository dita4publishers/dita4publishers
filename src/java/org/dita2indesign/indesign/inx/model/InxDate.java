 ...
 *
 */
public class InxDate extends InxValue {
	 ...
	 * @throws Exception 
	 */
	public InxDate(String rawValue) throws Exception {
		String dateStr = rawValue;
		if (dateStr.startsWith("T_")) {
			dateStr = dateStr.substring(2);
		}
		if (dateStr != null && !"".equals(dateStr)) {
			value = format.parse(dateStr);
		}
	}
