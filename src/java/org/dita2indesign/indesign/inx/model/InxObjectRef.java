...
/**
 * Represents a reference to another object by object ID.
 */
public class InxObjectRef extends InxString {

	/**
	 * @param rawValue
	 */
	public InxObjectRef(String rawValue) {
		super(rawValue);
	}
