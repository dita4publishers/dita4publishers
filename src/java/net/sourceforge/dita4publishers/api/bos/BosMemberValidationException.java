...
/**
 * Thrown when a BOS has invalid members.
 */
public class BosMemberValidationException extends BosException {

	/**
	 * @param message
	 */
	public BosMemberValidationException(String message) {
		super(message);
	}
	 ...
	 * @param cause
	 */
	public BosMemberValidationException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param cause
	 */
	public BosMemberValidationException(Throwable cause) {
		super(cause);
	}
